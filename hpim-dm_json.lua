...
----------------------------------------
local pf_type               = ProtoField.new    ("Type", "hpim.type", ftypes.STRING)
local pf_boot_time        = ProtoField.new    ("Boot Time", "hpim.boot_time", ftypes.STRING)
local pf_tree_source = ProtoField.new("Source", "hpim.options.tree_source", ftypes.STRING)
local pf_tree_group = ProtoField.new("Group", "hpim.options.tree_group", ftypes.STRING)
local pf_hello_holdtime = ProtoField.new("Holdtime", "hpim.options.hello_holdtime", ftypes.STRING)
local pf_hello_generation_id = ProtoField.new("Generation ID", "hpim.options.hello_generation_id", ftypes.STRING)
local pf_assert_metric = ProtoField.new("Metric", "hpim.options.assert_metric", ftypes.STRING)
local pf_assert_metric_preference = ProtoField.new("Metric Preference", "hpim.options.assert_metric_preference", ftypes.STRING)
local pf_neighbor_boot_time = ProtoField.new("Neighbor Boot Time", "hpim.options.neighbor_boot_time", ftypes.STRING)
local pf_sequence_number = ProtoField.new("SequenceNumber", "hpim.options.sequence_number", ftypes.STRING)
local pf_my_snapshot_sequence_number = ProtoField.new("My Snapshot Sequence Number", "hpim.options.my_snapshot_sequence_number", ftypes.STRING)
local pf_neighbor_snapshot_sequence_number = ProtoField.new("Neighbor Snapshot Sequence Number", "hpim.options.neighbor_snapshot_sequence_number", ftypes.STRING)
local pf_checkpoint_sequence_number = ProtoField.new("Checkpoint Sequence Number", "hpim.options.checkpoint_sequence_number", ftypes.STRING)

local pf_sync_sequence_number = ProtoField.new("Sync Sequence Number", "hpim.options.sync_sequence_number", ftypes.STRING)
local pf_master_flag = ProtoField.new("Master flag", "hpim.options.master_flag", ftypes.STRING)
local pf_more_flag = ProtoField.new("More flag", "hpim.options.more_flag", ftypes.STRING)
