...
class CustomFilter(logging.Filter):
    def filter(self, record):
        return (record.name.startswith("hpim") and (record.name.startswith("hpim.KernelEntry") or record.name.startswith("hpim.Interface")) or
                                                   record.name == "tests") and \
...
class Test1(Test):
    def __init__(self):
        expectedState = {"R1": {"eth0": "Created RootInterfaceOriginator",
                                "eth1": "Created NonRootInterface",
                                "eth2": "Created NonRootInterface",
                                "eth3": "Created NonRootInterface"},
                         "R2": {"eth0": "Created RootInterface",
                                "eth1": "Created NonRootInterface",
                                "eth2": "Created NonRootInterface"},
                         "R3": {"eth0": "Created RootInterface",
                                "eth1": "Created NonRootInterface"},
                         "R4": {"eth0": "Created RootInterface",
                                "eth1": "Created NonRootInterface"},
                         "R5": {"eth0": "Created RootInterface",
                                "eth1": "Created NonRootInterface"},
                         "R6": {"eth0": "Created RootInterface",
                                "eth1": "Created NonRootInterface"},
                         "R7": {"eth0": "Created NonRootInterface",
                                "eth1": "Created NonRootInterface",
                                "eth2": "Created RootInterface"},
                         }
