...
tcpdump -i eth0 -w /hosthome/Desktop/test_newproto/test_interest/TestResults/Router7_Router5.pcap &
tcpdump -i eth1 -w /hosthome/Desktop/test_newproto/test_interest/TestResults/Router7_Client0.pcap &
tcpdump -i eth2 -w /hosthome/Desktop/test_newproto/test_interest/TestResults/Router7_Router2.pcap &
