...
tcpdump -i eth0 -w /hosthome/Desktop/test_newproto/test_sync/TestResults/Router1_Source.pcap &
tcpdump -i eth1 -w /hosthome/Desktop/test_newproto/test_sync/TestResults/Router1_Router2.pcap &
tcpdump -i eth2 -w /hosthome/Desktop/test_newproto/test_sync/TestResults/Router1_Router3.pcap &
tcpdump -i eth3 -w /hosthome/Desktop/test_newproto/test_sync/TestResults/Router1_Router4.pcap &
